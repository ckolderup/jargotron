...
class Jargotron
  ...
  def self.collate_replies
    ...
    last_category_attempt_stamp = category_attempt.andand.created_at.andand.to_time.andand.to_i
    last_property_attempt_stamp = property_attempt.andand.created_at.andand.to_time.andand.to_i
